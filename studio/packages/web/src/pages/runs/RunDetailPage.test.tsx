...
vi.mock('../../api/runs', async (importActual) => ({
  ...
  /* #1065, and the mount-effect reason above applies verbatim — `RunDiagnostics` reads
  ...
  /* Mocked so an un-mocked write cannot reach `fetch`. NOT for the mount-effect
     reason above, which is specific to a member called from a MOUNT EFFECT: this one is
