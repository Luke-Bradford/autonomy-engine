...
4d. **NEVER TOUCH ANOTHER PROJECT'S CONTAINERS OR DATABASES (#1271).** This machine also runs the
    ...
    When you need a real database, START YOUR OWN throwaway container named `studio-<issue>-…`
    (e.g. `docker run -d --rm --name studio-1162-pg -e POSTGRES_HOST_AUTH_METHOD=trust
    -p 127.0.0.1:<free port>:5432 postgres:17`), and remove it before the fire ends.
