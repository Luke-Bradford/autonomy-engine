...
_REVIEW_RULES_AND_FORMAT = (
    ...
    "The verdict line is the LAST line of your response: nothing after it -- no note on "
    "what you read or ran, no caveat, no sign-off. Text after the verdict line fails the "
    "gate exactly like a missing verdict (#1266). If you want to state your scope (e.g. "
    "that you reviewed the diff only and did not run the tests), put it in ONE line "
    "BEFORE the `### Verdict` heading, or leave it out.\n"
