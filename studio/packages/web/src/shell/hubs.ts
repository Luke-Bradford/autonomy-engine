...
export const HUBS: readonly Hub[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      // #1115 — beside Connections, which the data-movement spec (§13) scopes
      // it as in as many words: "a Datasets list + detail beside Connections.
      // No new hub, no parallel authoring idiom." A dataset is an ADDRESS in a
      // store, so it is meaningless without the connection above it, and an
      // operator hunting for one will look at the other.
